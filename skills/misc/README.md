...
- **[bootstrap-orchestration](./bootstrap-orchestration/SKILL.md)** — Install, repair, or conservatively update the minimal repo-local `.agents` scaffold required by the orchestration system.
